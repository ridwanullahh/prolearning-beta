...
const FixedMarketplacePage: React.FC = () => {
  ...
  // Course Card Component (defined inside the main component to access utility functions)
...
export default FixedMarketplacePage;
