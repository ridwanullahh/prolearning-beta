      ...
      <div className="container mx-auto grid grid-cols-1 items-center gap-12 px-4 md:grid-cols-2 md:px-6 lg:gap-20">
        ...
        >
          <div className="relative h-64 w-64">
            ...
            >
              <Globe className="h-full w-full text-green-200/50 dark:text-green-800/50" />
            </motion.div>
            <Globe className="absolute left-1/2 top-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 text-green-500" />
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, x: -50 }}
        ...
        >
          ...
          <p className="max-w-xl text-lg text-gray-600 dark:text-gray-300">
            Our curriculum is aligned with international standards, catering to
            learners from all over the world. Access a world-class education
            from anywhere.
          </p>
